/** @typedef {typeof __propDef.props}  PrismProps */
/** @typedef {typeof __propDef.events}  PrismEvents */
/** @typedef {typeof __propDef.slots}  PrismSlots */
/**
 ...
 */
export default class Prism extends SvelteComponentTyped<{
    [x: string]: any;

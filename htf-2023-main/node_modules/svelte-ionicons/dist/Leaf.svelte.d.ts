/** @typedef {typeof __propDef.props}  LeafProps */
/** @typedef {typeof __propDef.events}  LeafEvents */
/** @typedef {typeof __propDef.slots}  LeafSlots */
/**
 ...
 */
export default class Leaf extends SvelteComponentTyped<{
    [x: string]: any;

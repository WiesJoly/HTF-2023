/** @typedef {typeof __propDef.props}  FishProps */
/** @typedef {typeof __propDef.events}  FishEvents */
/** @typedef {typeof __propDef.slots}  FishSlots */
/**
 ...
 */
export default class Fish extends SvelteComponentTyped<{
    [x: string]: any;

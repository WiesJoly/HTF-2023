/** @typedef {typeof __propDef.props}  BeerProps */
/** @typedef {typeof __propDef.events}  BeerEvents */
/** @typedef {typeof __propDef.slots}  BeerSlots */
/**
 ...
 */
export default class Beer extends SvelteComponentTyped<{
    [x: string]: any;
